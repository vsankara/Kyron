...
@Entity
@NamedQuery(name = "CasDBMenu.findAll", query = "select o from CasDBMenu o order by o.description")
@Table(name = "CAS_MENU")
public class CasDBMenu extends BaseCompositeModelObject   {
    ...
    public final boolean equals(Object other) {
        ...
        final CasDBMenu normalModel = (CasDBMenu)other;
