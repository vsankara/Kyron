...
@Entity
@NamedQuery(name = "RefComProcedure.findAll", 
    query = "select o from RefComProcedure o")
@Table(name = "REF_COM_PROCEDURE")
public class RefComProcedure extends BaseRefModelObject   {
    @Id
